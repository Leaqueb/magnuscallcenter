...
return array (
	/*new '' => '', */
	'Usted entro en descanso con exito' => 'Você entrou em pausa com sucesso',
	'Usted no se puede loquear porque no esta dentro de ningun turno, campaña: ' => 'Você não pode entrar nesta campanha porque esta não esta dentro de nenhum turno, campanha: ',
	'Seleccione otra campaña' => 'Selecione outra campanha',
	...
	'Payment' => 'Pagamentos',
	'Phone Book' => 'Agenda Telefônica',
	'Phone Number' => 'Números Telefônicos',
	'Plan' => 'Planos',
	'Poll' => 'Enquetes',
	'Prefix' => 'Prefixos',
	'Provider' => 'Provedores',
...
'Action class {class} must implement the "run" method.' => 'A classe Action {class} deve implementar o método "run".',
  ...
  'Invalid operator "{operator}".' => 'User inválido: "{opeator}".',
  'Last &gt;&gt;' => 'Último Last &gt;&gt;',
  ...
  'Unknown operator "{operator}".' => 'User desconhecido: "{operator}".',
